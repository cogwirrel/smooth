...
parser.add_argument('desc', metavar='DESC', type=str, nargs=argparse.REMAINDER,
...
with sqlite3.connect(DB_FILE) as conn:
	cur = conn.execute('insert into experiment (sha, description) values (?,?)', (args.sha, ' '.join(args.desc)))
	print cur.lastrowid
